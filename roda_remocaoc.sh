...
if [ "${vies}" == "com" ] ; then
  ...
  #/cygdrive/c/Users/haylton.bernardes/Anaconda3/rstudio.exe Codigos/Roda_Conjunto_V1.1_by_model.R
  /cygdrive/c/'Program Files'/RStudio/bin/rstudio.exe Codigos/Roda_Conjunto_V1.1_by_model.R
  ...
  cp ${dir_in}/RemoveViesNuvem/Arq_Saida_com_remocao_vies/*${model}*   ${dir_in}/EsquemaSMAP_nuvem/tmp/${model}/.
   ...
   echo "---------------------------------------"
   /cygdrive/c/Users/haylton.bernardes/Anaconda3/python.exe Codigos/platlon2pmedia.py ${model} ${date_today} ${n_prev}
   rm -f  ${dir_in}/EsquemaSMAP_nuvem/tmp/${model}/*
