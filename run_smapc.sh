...
/cygdrive/c/Users/haylton.bernardes/Downloads/unzip.exe -q Modelos_Chuva_Vazao_${date_today}.zip
...
/cygdrive/c/Users/haylton.bernardes/Anaconda3/rstudio.exe ${script_name}
...
#      vazao total
##########################
/cygdrive/c/Users/haylton.bernardes/Anaconda3/python.exe PosProc_total.py ${date_today} ${model} ${n_prev} ${vies}
